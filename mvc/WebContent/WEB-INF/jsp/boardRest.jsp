...
div.boardList>div.board:hover {
	background-color: lime
}

div.boardDetail>div.board>div.board_content>pre {
	margin: 1px;
	border: 1px solid;
}
...
/*글선택*/
//  $('div.boardPage>div.boardList').on("click","div.board",fouction(e){
// 	 console.log($(e.target).html());
// 	 var board_no = $(e.target).html();
// 	 $.ajax({
// 		 url:"/mvc/board/detail/" +board_no
// 		 ,method:"get";
// 	 	 ,success:function(data){
// 	 		 $divBoardDetail=("div.boardDetail");
// 			 $divBoardDetail.find("div.board>div.board_no>span").html(baord.);
// 			 $divBoardDetail.find("div.board>div.board_content>pre").html(board);
// 			 $divBoardDetail.show();
// 	 	 }
// 	 	 ,error:function(xhr){
// 	 		alert("실패:" + xhr.status);
...
<body>
	<div class="boardPage">
		<h3>게시물 목록</h3>
		<div class="boardInfo">
			현재페이지:<span class="currentPage"></span>/ 총페이지수: <span
				class="totalPage"></span>
